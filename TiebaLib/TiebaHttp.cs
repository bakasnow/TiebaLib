    ...
    internal static class TiebaHttp
    {
        public static string Get(string url, string cookie = "")
        {
            ...
            HttpItem item = new HttpItem()
            {
                ...
                UserAgent = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.162 Safari/537.36 Edg/80.0.361.109",//用户的浏览器类型，版本，操作系统     可选项有默认值
                Accept = "text/html, application/xhtml+xml, */*",//    可选项有默认值
                ContentType = "text/html",//返回类型    可选项有默认值
                Referer = "https://tieba.baidu.com/",//来源URL     可选项
